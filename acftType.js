let pistonAcft = ['C172', 'C182', 'C152', 'P28A', 'SR20', 'H47', 'C150', 'PA22', 'C82R', 'AP32', 'C208', 'LA4', 'AA5', 'DV20', 'P28S', 'SR22', 'M20T', 'C42', 'TB20', 'VL3', 'ULAC', 'B36T', 'P32R', 'DIMO', 'PC12',
    ...
    'P149', 'AVID', 'UF13', 'AS29', 'PA30', 'C337', 'TBM8', 'CH7A', 'DAL4', 'R300', 'JUNR', 'C175', 'C140', 'PC6T', 'M700', 'LXR', 'BE23', 'LNC2', 'AT8T', 'SB91', 'Z26', 'PIVE', 'Z37P', 'MCR4', 'PNR4',
    'EUPA', 'M600', 'SD4', 'TARR', 'DR30', 'CE43', 'SPIT', 'NAVI', 'D150', 'C185', 'ST75', 'AT6T', 'AT5T', 'CH7B', 'PA25', 'PA12', 'TFK2', 'AV68', 'RS18', 'D250', 'RF5', 'AN2', 'TFUN', 'GA8', 'BW60', 'SLG4',
    'DTA1', 'PP3'             

];
let gliderAcft = ['DG80', 'DG40', 'EB29', 'AS31', 'AS25', 'DUOD', 'VENT', 'DISC', 'AS21'];
let turboAcft = ['B350', 'L2T', 'F406', 'SF34', 'V22', 'BE30', 'C414', 'DA62', 'AT76', 'SW4', 'DA42', 'SC7', 'PA34', 'DA42', 'P68', 'BE9L', 'DHC6', 'AT75', 'AN30', 'C212', 'D228', 'C310', 'AT45',
    ...
    'DC3', 'PA27', 'AT73', 'BE76', 'C320', 'PA23', 'AT43', 'SB20', 'C160', 'C303', 'C402', 'BE55', 'BE95', 'B58T', 'AC50', 'D28D', 'AC95' 
];
let helAcft = ['EC35', 'EC45', 'EC30', 'EC55', 'H60', 'R44', 'MI8', 'A139', 'AS32', 'G2CA', 'EC20', 'B505', 'EC75', 'A169', 'A109', 'AS55', 'R22', 'AS3B', 'LYNX', 'AS65', 'B407', 'H53S', 'AS50', 'B429',
    'B06', 'H500', 'H64', 'NH90', 'R66', 'S92', 'MM16', 'CDUS', 'A189', 'MT', 'S76', 'EXPL', 'CLON', 'BK17', 'KMAX', 'H269', 'B212', 'EN28'    
   ];
let twoEngAcft = ['B738', 'B737', 'A321', 'B752', 'A320', 'A333', 'B38M', 'A20N', 'B789', 'B77W', 'A21N', 'B789', 'B38M', 'B739', 'BCS3', 'B762', 'B763', 'A332', 'A319', 'B734', 'A359', 'B788', 'B77W', 'B77L', 'B763', 'A339',
    'B734', 'B78X', 'A35K', 'A332', 'E75L', 'E190', 'B753', 'E190', 'E295', 'B78X', 'E190', 'A30B', 'B39M', 'B772', 'E170', 'B764', 'E195', 'E290', 'A306', 'BCS1', 'A19N', 'AURA', 'B733', 'E75S', 'A337'
         
];
let fourEngAcft = ['C17', 'A388', 'B748', 'B744', 'A343', 'A400', 'A346', 'A124', 'K35R', 'C5M', 'AN12'  ];
let businessAcft = ['LJ45', 'GL5T', 'CL60', 'GL7T', 'GLF5', 'GA6C', 'GLEX', 'C525', 'PRM1', 'F900', 'C700', 'C550', 'E55P', 'C56X', 'E55P', 'LJ35', 'PC24', 'C25C', 'C25A', 'CRJX', 'SF50', 'C680',
    ...
    'C25M', 'E3TF', 'FA7X', 'E35L', 'E550', 'H25B', 'C650', 'GALX', 'F100', 'FA8X', 'LJ55', 'E545', 'B712', 'C55B', 'GA7C'          
]